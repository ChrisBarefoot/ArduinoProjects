...
//
//starting from flat side of snes controller
//pin 1 - goes to 5v on the arduino
//pin 2 - goes to pin 6 on the arduino
//pin 3 - goes to pin 7 on the arduino
//pin 4 - goes to pin 12 on the arduino
//pin 7 - goes to ground on the arduino
